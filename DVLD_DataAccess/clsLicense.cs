    ...
    public class clsLicenseData
    {
        ...
        public static bool GetLicenseInfoByID(int LicenseID,ref int ApplicationID, ref int DriverID, ref int LicenseClass,
            ...
            ref float PaidFees,ref bool IsActive, ref byte IssueReason, ref int CreatedByUserID)
            {
                ...
                SqlCommand command = new SqlCommand("SP_GetLicenseByID", connection);
        ...
        public static int GetActiveLicenseIDByPersonID(int PersonID,int LicenseClassID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_GetActiveLicenseByPersonIDAndClass", connection);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public static bool DeactivateLicense(int LicenseID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_DeactivateLicenseByID", connection);
            command.CommandType = CommandType.StoredProcedure;
