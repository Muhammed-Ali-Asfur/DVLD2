...
namespace DVLD_DataAccess
{
    public class clsApplicationData
    {
        ...
        public static DataTable GetAllApplications()
            {
                ...
                SqlCommand command = new SqlCommand("SP_GetAllApplicationsList", connection);
            command.CommandType = CommandType.StoredProcedure;
             ...
             float PaidFees,  int CreatedByUserID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_InsertApplication", connection);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public static bool DeleteApplication(int ApplicationID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_DeleteApplicationByID", connection);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public static int GetActiveApplicationIDForLicenseClass(int PersonID, int ApplicationTypeID,int LicenseClassID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_GetActiveLocalDrivingApplicationID", connection);
            command.CommandType = CommandType.StoredProcedure;
