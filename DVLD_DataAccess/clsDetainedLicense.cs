    ...
    public class clsDetainedLicenseData
    {
        ...
        public static bool GetDetainedLicenseInfoByID(int DetainID, 
            ...
            ref int ReleasedByUserID,ref int ReleaseApplicationID)
            {
                ...
                SqlCommand command = new SqlCommand("SP_GetDetainedLicenseByID", connection);
         ...
         ref int ReleasedByUserID, ref int ReleaseApplicationID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_GetLastDetainedLicenseByLicenseID", connection);
            command.CommandType = CommandType.StoredProcedure;
            ...
            float FineFees,  int CreatedByUserID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_InsertDetainedLicense", connection);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public static bool IsLicenseDetained(int LicenseID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_IsLicenseCurrentlyDetained", connection);
            command.CommandType = CommandType.StoredProcedure;
