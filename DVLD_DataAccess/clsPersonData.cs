...
namespace DVLD_DataAccess
{
    public class clsPersonData
    {
         ...
         ref int NationalityCountryID, ref string ImagePath)
        {
            ...
            SqlCommand command = new SqlCommand("SP_GetPersonByNationalNo", connection);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public static bool DeletePerson(int PersonID)
        {
            ...
            SqlCommand command = new SqlCommand("SP_DeletePersonByID", connection);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public static bool IsPersonExist(string NationalNo)
        {
            ...
            SqlCommand command = new SqlCommand(" SP_CheckPersonByNationalNoExists", connection);
            command.CommandType = CommandType.StoredProcedure;
